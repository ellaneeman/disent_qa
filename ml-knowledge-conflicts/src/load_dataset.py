...
DATASETS = {
    ...
    "NaturalQuestionsTrainTrain": (
        NaturalQuetsionsDataset,
        f"/{data_path}/v10-simplified_simplified-nq-train_train_split.csv",

        ),
    "NaturalQuestionsTrainVal": (
        NaturalQuetsionsDataset,
        f"/{data_path}/v10-simplified_simplified-nq-train_val_split.csv",

        ),
    "NaturalQuestionsDevAny": (
        NaturalQuetsionsDataset,
        f"/{data_path}/simplified-nq-dev_any.csv",
        ),
}
